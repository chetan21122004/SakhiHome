    ...
    "@graph": [
      {
        ...
        description: `${BRAND_NAME} connects South Mumbai households with vetted maid, cleaning, childcare, elder support, and cooking help.`,
        ...
        <main className="flex-1">
          <LocalProgrammaticTemplate
            data={{
              ...
              sideCtaDescription: `Get recommendations based on family size, timing, and priorities in ${AREA_SERVED_LOCALITY} and nearby Mumbai areas. Indicative pricing: ${service.priceRange}.`,
