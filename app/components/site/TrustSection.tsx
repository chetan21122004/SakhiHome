...
const items = [
  { icon: Users, num: "500+", title: "Maid Network", desc: "A strong, growing network built for South Mumbai families." },
...
const mobileShortDesc: Record<string, string> = {
  "Maid Network": "Local network built for South Mumbai families.",
  ...
  <div className="md:hidden">
    ...
    <div className="mx-auto max-w-[26rem] text-left">
      ...
      <p className="mt-3 text-[13.5px] leading-relaxed text-white/65">
        Not a faceless app — your local maid partner in South Mumbai.
      </p>
        ...
        <div className="hidden md:block">
          <div className="grid md:grid-cols-[auto_1fr] gap-8 items-center mb-16 max-w-5xl mx-auto text-center md:text-left">
            <div className="hidden md:flex justify-start">
              <img src={dementiaDoodle} alt="Illustration representing dependable maid care and family support in South Mumbai" className="w-64 lg:w-80 object-contain drop-shadow-xl animate-float" />
            </div>
            <div>
              ...
              <p className="mt-5 text-lg text-white/70 max-w-xl mx-auto md:mx-0">
                {"We're not a faceless app. We're your local maid partner in South Mumbai."}
              </p>
            </div>
          </div>
