    ...
    <footer className="relative overflow-hidden bg-dark text-dark-foreground">
      ...
      <div className="relative container mx-auto px-4 pt-16 pb-10 md:px-6 md:pt-20">
        ...
        <div className="md:hidden">
          <div className="mx-auto mb-7 h-px max-w-3xl bg-gradient-to-r from-transparent via-accent/70 to-transparent" />
          <div className="space-y-5">
            <div className="relative overflow-hidden rounded-[1.75rem] border border-white/[0.12] bg-white/[0.04] p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_20px_60px_-36px_hsl(var(--primary)/0.55)]">
              ...
              <div className="grid grid-cols-2 gap-2">
                {[
                  ...
                  <a
                    key={item.label}
                    href={item.href}
                    className="rounded-xl border border-white/10 bg-white/[0.03] px-3 py-2 text-center text-xs font-semibold text-dark-muted transition-smooth hover:border-accent/40 hover:text-accent"
                  >
                    {item.label}
                  </a>
                ))}
            ...
            <div className="rounded-2xl border border-primary/25 bg-gradient-to-br from-primary/10 to-transparent p-4">
              <h4 className="mb-4 font-display text-[11px] font-bold uppercase tracking-[0.18em] text-accent">Contact</h4>
              <ul className="space-y-3 text-sm text-dark-foreground/90">
