...
const EnquirySection = () => {
  ...
  return (
    <section id="enquiry" className="relative py-16 md:py-20 bg-gradient-soft overflow-hidden">
      {/* Blob background texture */}
      <img
        src={blobBg}
        alt=""
        aria-hidden
        className="absolute inset-0 w-full h-full object-cover opacity-[0.05] pointer-events-none select-none mix-blend-multiply"
      />

      {/* Soft brand orbs */}
      <div
        className="absolute top-10 -left-24 h-72 w-72 rounded-full bg-accent/15 blur-[110px] pointer-events-none"
        aria-hidden
      />
      <div
        className="absolute bottom-10 -right-24 h-80 w-80 rounded-full bg-primary/15 blur-[120px] pointer-events-none"
        aria-hidden
      />
      ...
      <div className="container relative mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <h2 className="mt-5 font-display text-4xl md:text-5xl lg:text-6xl font-extrabold text-primary-deep text-balance leading-[1.05]">
        ...
        <div className="grid lg:grid-cols-[1fr_1.4fr] gap-8 items-stretch max-w-6xl mx-auto">
          {/* Left — trust panel */}
          <aside className="relative overflow-hidden rounded-[2rem] bg-gradient-dark-radial p-8 md:p-10 text-dark-foreground shadow-elevated">
            <div className="absolute inset-0 bg-grid-light opacity-20" aria-hidden />
            <div
              className="absolute -top-24 -right-24 h-64 w-64 rounded-full bg-accent/30 blur-[90px] animate-glow-pulse pointer-events-none"
              aria-hidden
            />

            <div className="relative">
              <div className="inline-flex items-center gap-2 rounded-full glass px-4 py-1.5 text-[11px] font-bold text-accent uppercase tracking-wider">
              ...
              <p className="mt-3 text-sm md:text-base text-dark-muted">
              ...
              <div className="mt-9 grid grid-cols-2 gap-3">
                <a
                  ...
                  className="flex flex-col gap-1 rounded-2xl glass border border-white/10 px-4 py-3 transition-smooth hover:border-accent/40"
                >
                  <span className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-wider text-accent">
                    <MessageCircle className="h-3.5 w-3.5" />
                    WhatsApp
                  </span>
                  <span className="text-sm font-semibold">Chat instantly</span>
                </a>
                <a
                ...
                >
                  ...
                  <span className="text-sm font-semibold">+91 91724 75977</span>
                </a>
              </div>

              <p className="mt-6 text-[11px] text-dark-muted">
          ...
          {/* Right — form card */}
          <div className="relative rounded-[2rem] bg-card border border-border shadow-card p-6 md:p-10">
            {submitted ? (
              <div className="flex flex-col items-center text-center py-10">
                <div className="grid h-16 w-16 place-items-center rounded-full bg-gradient-brand text-white shadow-glow">
                  <CheckCircle2 className="h-8 w-8" />
                </div>
                <h3 className="mt-6 font-display text-3xl font-extrabold text-primary-deep">
                  Enquiry received!
                </h3>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <select
                        ...
                        className="flex h-12 w-full rounded-md border border-input bg-background pl-10 pr-3 py-2 text-sm appearance-none ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                      >
