 ...
 * Drives all programmatic SEO pages:
...
export type Society = {
  name: string;
  slug: string;
  /** Which area this society belongs to — set automatically via AREAS map */
  areaId: string;
};
...
export type AreaRecord = {
  ...
  shortName: string;
  description: string;
  /** Prominent landmark / anchor used in page copy */
  landmark: string;
  pincode: string;
  /** Nearby areas / micro-localities for copy variation */
  nearbyMicroLocalities: string[];
  seoTitle: string;
  metaDescription: string;
  /** Rough demand tier — used to prioritise sitemap + internal linking */
...
/** Flat list of every society across all areas, with areaId injected */
...
export function getSocietyBySlug(slug: string): (Society & { area: AreaRecord }) | undefined {
